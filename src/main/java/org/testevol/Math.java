...
public class Math {
	...
	public static int sumFile() throws IOException{
		BufferedReader fileReader = new BufferedReader(new InputStreamReader(Math.class.getResourceAsStream("test.txt")));
		int sum = 0;
		String line;
